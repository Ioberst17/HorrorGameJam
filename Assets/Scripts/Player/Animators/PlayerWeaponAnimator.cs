...
public class PlayerWeaponAnimator : PlayerArmWeaponAnimatorCommonFunctionality
{
    Quaternion animationRotation;

    // for vfx animations
    [SerializeField] Transform currentFirePoint;
    PlayerFirePointAnimator firePointAnimator;
    ...
    override public void Start()
    {
        ...
        // get key references
        firePointAnimator = GetComponentInChildren<PlayerFirePointAnimator>();
