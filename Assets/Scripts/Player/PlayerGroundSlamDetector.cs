...
/// <summary>
/// Meant to handle hit detection and pass it back up to GroundSlam
/// </summary>
public class PlayerGroundSlamDetector : MonoBehaviour 
{
    ...
    //    {
    //        // check to see if hit something that takes damage, if it hasn't check for ground 'nondamageable')
    //        CheckForNonDamagable(CheckForDamagable()); 
    //    }
    //}
    ...
    ///// 
    ///// </summary>
    ///// <param name="alreadyHitSomething"></param>
