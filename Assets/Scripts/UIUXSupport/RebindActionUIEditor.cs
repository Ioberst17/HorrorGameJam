...
////TODO: support multi-object editing
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        {
            m_IsMenuObjectActiveProperty = serializedObject.FindProperty("m_isMenuObjectActive");
            ...
            m_CancellationTextProperty = serializedObject.FindProperty("m_CancellationText");
            m_CancellationImageProperty = serializedObject.FindProperty("m_CancellationImage");
            m_CancellationBoolProperty = serializedObject.FindProperty("m_CancellationBool");
            ...
            m_InfoToPassProperty = serializedObject.FindProperty("m_infoToPass");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.PropertyField(m_IsMenuObjectActiveProperty);
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_CancellationTextProperty);
                EditorGUILayout.PropertyField(m_CancellationImageProperty);
                EditorGUILayout.PropertyField(m_CancellationBoolProperty);
                EditorGUILayout.PropertyField(m_InfoToPassProperty);
            }
        ...
        private SerializedProperty m_CancellationTextProperty;
        private SerializedProperty m_CancellationImageProperty;
        private SerializedProperty m_CancellationBoolProperty;
        ...
        private SerializedProperty m_InfoToPassProperty;
        private SerializedProperty m_IsMenuObjectActiveProperty;
